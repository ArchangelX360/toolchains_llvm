...
def cc_toolchain_config(
    ...
    if target_os == "windows" and compiler == "clang-cl" and target_libc == "msvc":
        ...
        windows_cc_toolchain_config(
            ...
            # TODO: should we support that?
            # msvc_env_lib = ";".join([
            #     "{}/Windows_Kits/10/Lib/10.0.26100.0/ucrt/{}".format(sysroot_path, libpath_arch),
            #     "{}/Windows_Kits/10/Lib/10.0.26100.0/um/{}".format(sysroot_path, libpath_arch),
            #     "{}/VC/Tools/MSVC/14.50.35717/lib/{}".format(sysroot_path, libpath_arch),
            # ]),
